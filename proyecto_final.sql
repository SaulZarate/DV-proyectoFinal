...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2024 a las 21:28:52
...
(20, 16, 'pepe', 'argento', 'M', '0002-03-21', '', '2024-11-13 16:14:17');
...
(2, 'rick', 'sanchez', 'rick@turapp.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '54', '11', '12312312', 0, NULL, NULL, NULL, NULL, NULL, 'A', 0, '2024-10-03 19:31:29'),
...
(6, 'jason', 'statham', 'el.transportador@turapp.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '51', '22', '12312312', 2, NULL, NULL, NULL, NULL, NULL, 'A', 0, '2024-11-13 10:21:36');
...
--
ALTER TABLE `alojamientos`
  MODIFY `idAlojamiento` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `consulta_mensajes`
  MODIFY `idMensaje` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `eventos`
  MODIFY `idEvento` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `origenes`
--
ALTER TABLE `origenes`
  MODIFY `idOrigen` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `paquetes`
  MODIFY `idPaquete` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
