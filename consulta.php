    ...
    <main class="p-2 p-md-5">
        <section class="section row">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title border-bottom pb-2"><!-- < ?= $titlePage ?> --><?=strtoupper($consulta->asunto)?></h5>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapsePaquete" class="accordion-collapse collapse show" aria-labelledby="headingPaquete" data-bs-parent="#accordionConsulta">
                                    <div class="accordion-body">
                                        ...
                                        <p class="m-0"><b>Fecha de salida:</b> <?= $consulta->fechaSalida ? date("d/m/Y", strtotime($consulta->fechaSalida)) : "Sin fecha indicada" ?></p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-coppalseContacto" class="accordion-collapse collapse" aria-labelledby="flush-headingContacto" data-bs-parent="#accordionConsulta">
                                    <div class="accordion-body">
                                        ...
                                        <p class=""><b>Teléfono:</b> <?= $cliente->codPais || $cliente->codArea || $cliente->telefono ? "+{$cliente->codPais} {$cliente->codArea} {$cliente->telefono}" : "..." ?> </p>
