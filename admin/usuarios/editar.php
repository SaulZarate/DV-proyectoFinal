    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="form" class="row g-3">
                ...
                <div class="col-md-6">
                    <label for="password" class="form-label">Contraseña<i class="fa fa-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="La contraseña debe tener como mínimo 8 digitos, 1 mayúscula, 1 minúscula y 1 caracter especial"></i></label>
