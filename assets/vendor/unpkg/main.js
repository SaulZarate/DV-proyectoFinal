...
class b {
  constructor(A, g = {}) {
    ...
    this.el = s, this.el.innerHTML += `
      <div class="label-container">
        ...
        <a class="clear-button" href="javascript:void(0)" title="Borrar todo">
          &times;
        </a>
      </div>
      <label class="input-container">
        <input
          ...
          aria-label="Seleccione el/los archivo/s..."
          class="input-hidden"
  ...
  hasFiles() {
    return this.cachedFileArray.length > 0
  }
